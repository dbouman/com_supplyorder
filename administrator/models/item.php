...
defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	class SupplyorderModelItem extends JModel
	{
	/**
	* Item id
	*
	...
	*/
	...
	$cids = implode( ',', $cid );
	$query = 'DELETE FROM #__supplyorder'
	. ' WHERE id IN ( '.$cids.' )';
	...
	*/
	...
	$item->title = null;
	$item->alias = null;
	$item->employee_id = null;$item->account_id = null;
	$item->created = null;
	$item->created_by = 0;
