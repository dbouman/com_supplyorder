...
/**
  ...
  */
  ...
  parent :: __construct('#__supplyorder', 'id', $db);
  }
 /**
 ...
 /** check for existing name */
  $query = 'SELECT id FROM #__supplyorder WHERE title = ' . $this->_db->Quote($this->title) . ' AND catid = ' . (int) $this->catid;
