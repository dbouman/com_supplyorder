...
<?php
  ...
  JToolBarHelper::title( JText::_( 'Supplyorder' ), 'generic.png' );
  JToolBarHelper::publishList();
  JToolBarHelper::unpublishList();
  JToolBarHelper::deleteList();
  JToolBarHelper::editListX();
  JToolBarHelper::addNewX();
  JToolBarHelper::preferences('com_supplyorder','550');
  ?>
...
<?php
  ...
  {
  $row = &$this->items[$i];
 $link = JRoute::_( 'index.php?option=com_supplyorder&view=item&task=edit&cid[]='. $row->id );
 ...
 $row->cat_link = JRoute::_( 'index.php?option=com_categories&section=com_supplyorder&task=edit&type=other&cid[]='. $row->catid );
  ?>
