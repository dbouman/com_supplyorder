...
/**
  * Supplyorder Component Categories Model
  *
  * @package Supplyorder
  */
  class SupplyorderModelCategories extends JModel
  {
  /**
 ...
 function _buildQuery()
  ...
  $aid = $user->get('aid', 0);
 //Query to retrieve all categories that belong under the supplyorder section and that are published.
  ...
  .' LEFT JOIN #__supplyorder AS a ON a.catid = cc.id'
  .' WHERE a.published = 1'
  .' AND section = \'com_supplyorder\''
  .' AND cc.published = 1'
