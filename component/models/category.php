...
jimport('joomla.application.component.model');
  ...
  class SupplyorderModelCategory extends JModel
  {
  /**
* Category id
*
...
var $_id = null;
 ...
 // Get the pagination request variables
  $this->setState('limit', $mainframe->getUserStateFromRequest('com_supplyorder.limit', 'limit', $config->getValue('config.list_limit'), 'int'));
