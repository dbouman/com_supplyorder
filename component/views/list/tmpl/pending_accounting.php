	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%"	class="so_table">
		...
		?>
			<tr>
				...
				<td><a href="<?php echo JRoute::_( 'index.php?option=com_supplyorder&view=list&layout=pending_accounting&task=delete_request&request_id=' . $request['request_id'] ); ?>">Delete</a></td>
			</tr>
		<?php
			} 
		?>
